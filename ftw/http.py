...
class HttpUA(object):
    ...
    def build_request(self):
        ...
        if self.request_object.data != '':
               ...
               self.request_object.stop_magic is False:
                ...
                if m:
                    ...
                    if choice in possible_choices:
                        encoding = choice
            try:
                data_bytes = self.request_object.data.encode(encoding=encoding, errors="strict")
            ...
            request = request.replace('#data#', data_bytes.decode(encoding=encoding, errors="strict"))
        else:
